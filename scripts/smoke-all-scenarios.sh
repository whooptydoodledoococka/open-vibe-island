...
scenarios=(closed sessionList approvalCard questionCard completionCard longCompletionCard staleHermes unavailableHermes multipleRequests receiptDelivered contextPressure externalFeeds)
